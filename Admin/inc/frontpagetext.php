...
else
{
	...
	echo $tpl->fetch('../Includes/Templates/'.$aac_layout.'/top.tpl');
		...
		<p>You may modify the frontpage text right here!</p><br />
		<form action=\"save.php?save=FrontpageText\" method=\"POST\">
		";
		
		$oFCKeditor = new FCKeditor('FrontpageText') ;
		$oFCKeditor->BasePath = '../Includes/fckeditor/';
		$oFCKeditor->ToolbarSet = 'MyToolbar';
		$oFCKeditor->Value = file_get_contents("../Main/FrontpageText.txt");
		$oFCKeditor->Create() ;
		
		echo "
		<br /><br />
		<input type=\"submit\" name=\"submitbutton\" value=\"Change\" />
		</form>
		<br /><br />
		";
