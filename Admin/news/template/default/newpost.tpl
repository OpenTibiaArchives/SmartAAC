<form action="./index.php" method="post" id="form1">
	<div id="post">
		...
		<fieldset>
			...
			<textarea id="spellMessage" name="message" rows="15" cols="40" class="wide"></textarea>
		...
		<fieldset>
			...
			<div>
				<input id="locked" type="checkbox" name="locked" />
				<label for="locked">Lock this post. No comments allowed.</label>
			</div>
		</fieldset>
		<div>
